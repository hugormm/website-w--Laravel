...
<body>
    <header class="container-fluid d-flex flex-column align-items-center gap-4">
        <div class="row box mt-3 w-75 p-4 text-center">
            ...
            @if(!$dennied)
                @include('backoffice.layouts._components.nav_bo')
            @endif
        </div> 
    </header>
    ...
    <footer class="container-fluid d-flex flex-column align-items-center gap-4">
        <div class="row w-75">
            <div class="col box mt-3 pt-2 text-center">
                <p> Backoffice @ Sebastião Alves 2023</p>
            </div>
        </div>
    </footer>
