<main id="main" class="container-fluid">
        ...
        <div class="row d-flex flex-column margin_mobile">
            ...
            <div class="col-12 px-0 d-flex justify-content-center">
                <img src="<?= $dados["foto"]; ?>" alt="foto" class="img_about_me">
            </div>

            <div class="col-10 col-sm-9 about_me_text mobile d-none align-self-center">
                <div class="d-block" id="texto_menor"><?= substr($dados["texto"], 0, 500); ?> ...</div>
                <div class="d-none" id="texto_maior"><?= $dados["texto"]; ?></div>
